...
export class TopicGateway {
  ...
  async create(
    @MessageBody() createTopicDto: CreateTopicDto,
  ): Promise<WsResponse<WsResponseBody<CreateTopicDto, boolean>>> {
    return {
  ...
  async get(
    @MessageBody() getTopicDto: GetTopicDto,
  ): Promise<WsResponse<WsResponseBody<GetTopicDto, TopicModel>>> {
    return {
      event: GLOBAL_EVENT.CONSUME,
      data: {
  ...
  async delete(
    @MessageBody() deleteTopicDto: DeleteTopicDto,
  ): Promise<WsResponse<WsResponseBody<DeleteTopicDto, boolean>>> {
    return {
      event: GLOBAL_EVENT.CONSUME,
      data: {
